...
<script>
    $(document).ready(function() {
        ...
        <a href="{{ route('barangkeluar.saved_data') }}">
            ...
            <button id="addBarangBtn" class="btn btn-primary btn-sm">
                <i class="fas fa-plus"></i> Add barang keluar
            </button>
        `;
        ...
        function attachListeners(row) {
            ...
            row.querySelector('.remove-row').addEventListener('click', function(e) {
                ...
                fetch(`/delete-barang-keluar/${createdAt}`, {
                        method: 'DELETE',
                        headers: {
        ...
        function saveTableToLocalStorage() {
            ...
            localStorage.setItem('barangKeluarRows', JSON.stringify(rows));
        }


        function loadTableFromLocalStorage() {
            const savedRows = JSON.parse(localStorage.getItem('barangKeluarRows')) || [];
