        ...
        <table class="table table-bordered text-center mt-4" id="summaryTable">
          <tbody>
              ...
              <tr class="table-secondary">
                <td colspan="6" class="text-start fw-bold">Menu Mix</td>
                <td>Rp-</td>
            </tr>
            <tr class="table-light">
          ...
          <tr class="table-light">
              <td colspan="6" class="text-start fw-bold">Menu Cost</td>
              <td>Rp-</td>
          </tr>
          <tr class="table-secondary">
...
<!-- ✅ DataTable Init + Toolbar Buttons -->
<script>
